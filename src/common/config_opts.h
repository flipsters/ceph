...
OPTION(rgw_latency_bucket_duration_reset, OPT_INT, 3600) // sec time for next reset
OPTION(rgw_latency_bucket_duration_update, OPT_INT, 30) // sec time for next update
